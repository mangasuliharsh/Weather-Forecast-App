...
def getWeather():
    ...
    #weather
    api="https://api.openweathermap.org/data/2.5/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude
    )+"&units=metric&exclude=hourly&appid=e7704bc895b4a8d2dfd4a29d404285b6"
...
#timezone
timezonee=Label(root,font=("Helvetica",20),fg="white",bg="#57adff")
timezonee.place(x=650,y=20)
...
day2temp=Label(secondframe,bg="#282929",fg="#fff")
...
day3temp=Label(thirdframe,bg="#282929",fg="#fff")
...
day4temp=Label(fourthframe,bg="#282929",fg="#fff")
...
day5temp=Label(fifthframe,bg="#282929",fg="#fff")
...
day6temp=Label(sixthframe,bg="#282929",fg="#fff")
...
day7temp=Label(seventhframe,bg="#282929",fg="#fff")
